...
################################################################
# This is a generated script based on design: LEDcounter_scutimer_interrupt
#
...
# source LEDcounter_scutimer_interrupt_script.tcl
...
set design_name LEDcounter_scutimer_interrupt
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  # Create instance: UARTmodule2023_0, and set properties
  set UARTmodule2023_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:UARTmodule2023:1.0 UARTmodule2023_0 ]
  set_property -dict [ list \
CONFIG.FREQUENCY {0x05F5E100} \
 ] $UARTmodule2023_0
...
CONFIG.NUM_MI {3} \
  ...
  connect_bd_net -net UARTmodule2023_0_tx [get_bd_ports tx] [get_bd_pins UARTmodule2023_0/tx]
  connect_bd_net -net UARTmodule2023_0_tx_full [get_bd_pins UARTmodule2023_0/tx_full] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins UARTmodule2023_0/write_to_uart] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins UARTmodule2023_0/tx_data] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LEDs/s_axi_aclk] [get_bd_pins UARTmodule2023_0/clock] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins UARTmodule2023_0/reset] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins LEDs/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs LEDs/S_AXI/Reg] SEG_axi_gpio_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
