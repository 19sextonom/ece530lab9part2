...
#
# Filename    : LEDcounter_scutimer_interrupt.sh
...
#
# Generated by Vivado on Sun Apr 23 17:21:01 -0400 2023
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: LEDcounter_scutimer_interrupt.sh [-help]
# usage: LEDcounter_scutimer_interrupt.sh [-lib_map_path]
# usage: LEDcounter_scutimer_interrupt.sh [-noclean_files]
# usage: LEDcounter_scutimer_interrupt.sh [-reset_run]
#
...
# executing this script. Please type 'LEDcounter_scutimer_interrupt.sh -help' for more information.
#
...
# Script info
echo -e "LEDcounter_scutimer_interrupt.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ip/LEDcounter_scutimer_interrupt_processing_system7_0_0/sim/LEDcounter_scutimer_interrupt_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ip/LEDcounter_scutimer_interrupt_axi_gpio_0_0/sim/LEDcounter_scutimer_interrupt_axi_gpio_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ip/LEDcounter_scutimer_interrupt_rst_processing_system7_0_100M_0/sim/LEDcounter_scutimer_interrupt_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/hdl/LEDcounter_scutimer_interrupt.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ipshared/xilinx.com/uartmodule2023_v1_0/bbfifo_16x8.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ipshared/xilinx.com/uartmodule2023_v1_0/kcuart_rx.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ipshared/xilinx.com/uartmodule2023_v1_0/kcuart_tx.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ipshared/xilinx.com/uartmodule2023_v1_0/ClockedOneShot.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ipshared/xilinx.com/uartmodule2023_v1_0/uart_rx.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ipshared/xilinx.com/uartmodule2023_v1_0/uart_tx.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ipshared/xilinx.com/uartmodule2023_v1_0/BaudRateGenerator.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ipshared/xilinx.com/uartmodule2023_v1_0/UARTmodule2023.v" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ip/LEDcounter_scutimer_interrupt_UARTmodule2023_0_1/sim/LEDcounter_scutimer_interrupt_UARTmodule2023_0_1.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ip/LEDcounter_scutimer_interrupt_axi_gpio_0_1/sim/LEDcounter_scutimer_interrupt_axi_gpio_0_1.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ip/LEDcounter_scutimer_interrupt_xbar_0/sim/LEDcounter_scutimer_interrupt_xbar_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ip/LEDcounter_scutimer_interrupt_axi_gpio_1_0/sim/LEDcounter_scutimer_interrupt_axi_gpio_1_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/LEDcounter_scutimer_interrupt/ip/LEDcounter_scutimer_interrupt_auto_pc_0/sim/LEDcounter_scutimer_interrupt_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.LEDcounter_scutimer_interrupt xil_defaultlib.glbl -o LEDcounter_scutimer_interrupt_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./LEDcounter_scutimer_interrupt_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./LEDcounter_scutimer_interrupt.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key LEDcounter_scutimer_interrupt_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc LEDcounter_scutimer_interrupt_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./LEDcounter_scutimer_interrupt.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: LEDcounter_scutimer_interrupt.sh [-help]\n\
Usage: LEDcounter_scutimer_interrupt.sh [-lib_map_path]\n\
Usage: LEDcounter_scutimer_interrupt.sh [-reset_run]\n\
Usage: LEDcounter_scutimer_interrupt.sh [-noclean_files]\n\n\
